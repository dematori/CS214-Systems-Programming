...
#define malloc( x ) mymalloc(x)	// overriding the declaration of the original malloc()
#define free( x ) myfree(x)		// overriding the declaration of the original free()
...
void* mymalloc(size_t size);	// function declaration of malloc()
void myfree(void *ptr);			// function declaration of free()
